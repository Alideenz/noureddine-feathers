...
<svelte:head>
  <title>Terms of Service | Noureddine Feathers</title>
  <meta
    name="description"
    content="Terms of Service | Noureddine Feathers - Shop premium ostrich feather dusters, premium extendable lambswool dusters, premium lambswool dusters, ostrich feathers, and ostrich eggshells - handmade from 100% natural farm-raised ostrich feathers and eggshells"
  />
</svelte:head>
...
<div class="flex w-full flex-col gap-8 p-8 lg:w-3/5">
  ...
  <div class="flex flex-col gap-8">
    <div class="flex flex-col gap-4">
      <p>OVERVIEW</p>
      <p>
        This website is operated by Noureddine Feathers. Throughout the site,
        the terms "we", "us" and "our" refer to Noureddine Feathers. Noureddine
        Feathers offers this website, including all information, tools and
      ...
      <p>
        ...
        ("Terms of Service", "Terms"), including those additional terms of
        service and policies referenced herein and/or available by hyperlink.
        These Terms of Service apply to all users of the site, including without
        limitation users who are browsers, vendors, customers, merchants, and/
        or contributors of content. Please read these Terms of Service carefully
        ...
        agree to all the terms of service of this agreement, then you may not
    ...
    <div class="flex flex-col gap-4">
      ...
      <p>
        ...
        sole discretion to be unlawful, offensive, threatening, libelous,
    ...
    <div class="flex flex-col gap-4">
      ...
      <p>
        In no case shall Noureddine Feathers, our directors, officers,
    ...
    <div class="flex flex-col gap-4">
      ...
      <p>
        You agree to indemnify, defend and hold harmless Noureddine Feathers and
    ...
    <div class="flex flex-col gap-4">
      ...
      <div>
        ...
        <p>7751 Berkley St Burnaby, BC, Canada V5E 2J8</p>
        <p>CALL: 604-889-4117 / FAX: 604-986-0231</p>
        <p>76960 0503 BC0001</p>
        <!-- <p>[INSERT VAT NUMBER]</p> -->
      </div>
    </div>
  </div>
</div>
